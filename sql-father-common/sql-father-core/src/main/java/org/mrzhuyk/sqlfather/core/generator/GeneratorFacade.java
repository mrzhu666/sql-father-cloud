...
public class GeneratorFacade {
     ...
     * @return 表
     */
    public static GenerateVO generateAll(TableSchema tableSchema) throws TemplateException, IOException {
        // 校验表
     ...
     * @param field 字段
     */
    private static void validFiled(TableSchema.Field field) {
